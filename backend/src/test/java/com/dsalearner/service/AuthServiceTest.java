...
class AuthServiceTest {
 ...
 @Test void registerSuccessAndDuplicate(){
   ...
   when(jwt.generateAccessToken(any(),"a@b.com")).thenReturn("access"); when(jwt.generateRefreshToken(any())).thenReturn("refresh"); when(jwt.getRefreshTokenExpiryMs()).thenReturn(1000L);
